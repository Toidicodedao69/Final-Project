function init() {
    ...
    var yAxis_scale;    // Scale for the Y Axis
    var year_clicked;
  ...
  function UpdatePie(period) {
    ...
    d3.csv("../sources/temporary_visas_arrivals.csv").then(function(data) {
        ...
        function Update(new_data) {
            ...
            yAxis_scale.domain([d3.min(single_bar_data, function (d) {
                    return d;
                }), 
                d3.max(single_bar_data, function (d) {
                    return d;       
